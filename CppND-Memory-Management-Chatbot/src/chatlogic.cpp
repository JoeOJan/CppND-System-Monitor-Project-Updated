            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        ...
                        // from: https://stackoverflow.com/questions/40455882/compilation-error-when-trying-to-find-if-an-unique-ptr-in-a-vector
                        ...
                        if (newNode == _nodes.end())
                        {
                            ...
                            //std::unique_ptr<GraphNode> nptr(new GraphNode(id));
                            //auto nptr = std::make_unique<GraphNode>(id);
